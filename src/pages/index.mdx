...
- [Code GitHub](https://github.com/entest-hai/vscode-ssh-ssm-ec2)
...
cloudwatch to monitor and stop ec2

```tsx
// add cloudwatch alarm to turn off after 30 minute idle
const alarm = new aws_cloudwatch.Alarm(this, 'StopIdleEc2Pub', {
...
alarm.addAlarmAction(
  new aws_cloudwatch_actions.SnsAction(
    aws_sns.Topic.fromTopicArn(
      this,
      'MonitorEc2Topic',
      'arn:aws:sns:ap-southeast-1:IAM_USER_ID:MonitorEc2'
    )
  )
);
```
